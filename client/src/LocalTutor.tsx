...
// // // //     // Sirf numbers allow honge aur max 6 digits
...
// // // //         {/* Filter Bar with Divider Borders */}
// // // //         <div className="bg-white rounded-xl shadow-sm border border-slate-200 px-4 py-3 mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 divide-y sm:divide-y-0 sm:divide-x divide-slate-200">
...
// // // //             </div>
// // // //             <div className="flex-1 min-w-0">
// // // //               <label className="text-[10px] text-slate-400 font-bold block uppercase tracking-wider">PIN Code</label>
// // // //               <input 
// // // //                 type="tel"
// // // //                 inputMode="numeric"
// // // //                 pattern="[0-9]*"
...
// // // //                 className="w-full text-xs font-semibold text-slate-800 outline-none bg-transparent placeholder:text-slate-400 placeholder:font-normal"
// // // //               />
// // // //             </div>
// // // //           </div>
...
// // // //             <label className="text-[10px] text-slate-400 font-bold block uppercase tracking-wider">Board</label>
// // // //             <div className="relative">
// // // //               <select className="w-full text-xs text-slate-700 bg-transparent py-0.5 pr-5 font-semibold appearance-none outline-none cursor-pointer">
...
// // // //           {/* Class Field */}
// // // //           <div className="py-2 sm:py-0 sm:px-4">
// // // //             <label className="text-[10px] text-slate-400 font-bold block uppercase tracking-wider">Class</label>
// // // //             <div className="relative">
// // // //               <select className="w-full text-xs text-slate-700 bg-transparent py-0.5 pr-5 font-semibold appearance-none outline-none cursor-pointer">
...
// // // //           {/* Subject Field */}
// // // //           <div className="py-2 sm:py-0 sm:px-4">
// // // //             <label className="text-[10px] text-slate-400 font-bold block uppercase tracking-wider">Subject</label>
// // // //             <div className="relative">
// // // //               <select className="w-full text-xs text-slate-700 bg-transparent py-0.5 pr-5 font-semibold appearance-none outline-none cursor-pointer">
...
// // // //             <label className="text-[10px] text-slate-400 font-bold block uppercase tracking-wider">Sort by</label>
// // // //             <div className="relative">
// // // //               <select className="w-full text-xs text-slate-700 bg-transparent py-0.5 pr-5 font-semibold appearance-none outline-none cursor-pointer">
...
// // //         {/* Clean Filter Bar with Tall Vertical Dividers */}
// // //         <div className="bg-white rounded-xl shadow-sm border border-slate-200 px-6 py-4 mb-6 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 md:gap-0">
          
// // //           {/* PIN Code Field */}
// // //           <div className="flex items-center gap-3.5 flex-1 pr-0 md:pr-6">
// // //             <div className="w-8 h-8 rounded-full border border-blue-400 flex items-center justify-center text-blue-600 shrink-0">
// // //               <MapPin className="w-4 h-4" />
// // //             </div>
// // //             <div className="flex-1 min-w-0">
// // //               <label className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block leading-none mb-1">PIN CODE</label>
// // //               <input 
// // //                 type="tel"
// // //                 inputMode="numeric"
// // //                 pattern="[0-9]*"
...
// // //           {/* Divider */}
// // //           <div className="hidden md:block w-px self-stretch bg-slate-200 my-0.5" />

// // //           {/* Board Field */}
// // //           <div className="flex-1 px-0 md:px-6">
// // //             <label className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block leading-none mb-1">BOARD</label>
// // //             <div className="relative">
// // //               <select className="w-full text-xs text-slate-800 bg-transparent py-0 pr-5 font-semibold appearance-none outline-none cursor-pointer">
// // //                 <option value="">Select Board</option>
// // //                 <option value="cbse">CBSE</option>
// // //                 <option value="icse">ICSE</option>
// // //                 <option value="state">State Board</option>
...
// // //           {/* Class Field */}
// // //           <div className="flex-1 px-0 md:px-6">
// // //             <label className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block leading-none mb-1">CLASS</label>
// // //             <div className="relative">
// // //               <select className="w-full text-xs text-slate-800 bg-transparent py-0 pr-5 font-semibold appearance-none outline-none cursor-pointer">
// // //                 <option value="">Select Class</option>
// // //                 <option value="class-6-8">Class 6 - 8</option>
...
// // //           {/* Subject Field */}
// // //           <div className="flex-1 px-0 md:px-6">
// // //             <label className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block leading-none mb-1">SUBJECT</label>
// // //             <div className="relative">
// // //               <select className="w-full text-xs text-slate-800 bg-transparent py-0 pr-5 font-semibold appearance-none outline-none cursor-pointer">
// // //                 <option value="">Select Subject</option>
// // //                 <option value="maths">Mathematics</option>
...
// // //             <label className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block leading-none mb-1">SORT BY</label>
// // //             <div className="relative">
// // //               <select className="w-full text-xs text-slate-800 bg-transparent py-0 pr-5 font-semibold appearance-none outline-none cursor-pointer">
// // //                 <option value="">Select Option</option>
// // //                 <option value="price-asc">Price: Low to High</option>
...
// // //         {/* Filter Bar with Individual Floating Outlined Boxes */}
// // //         <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 mb-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3.5">
          
// // //           {/* PIN Code Field */}
// // //           <div className="flex flex-col">
// // //             <span className="text-[11px] font-bold text-slate-700 mb-1">PIN Code</span>
// // //             <div className="flex items-center gap-2 border border-slate-300 rounded-lg px-3 py-2 bg-white focus-within:border-blue-500 transition shadow-sm h-11">
...
// // //           {/* Board Field */}
// // //           <div className="flex flex-col">
// // //             <span className="text-[11px] font-bold text-slate-700 mb-1">Board</span>
// // //             <div className="relative border border-slate-300 rounded-lg px-3 py-2 bg-white focus-within:border-blue-500 transition shadow-sm h-11 flex items-center">
// // //               <select className="w-full text-xs text-slate-700 bg-transparent pr-6 font-medium appearance-none outline-none cursor-pointer">
// // //                 <option value="">Select Board</option>
// // //                 <option value="cbse">CBSE</option>
// // //                 <option value="icse">ICSE</option>
// // //                 <option value="state">State Board</option>
...
// // //           {/* Class Field */}
// // //           <div className="flex flex-col">
// // //             <span className="text-[11px] font-bold text-slate-700 mb-1">Class</span>
// // //             <div className="relative border border-slate-300 rounded-lg px-3 py-2 bg-white focus-within:border-blue-500 transition shadow-sm h-11 flex items-center">
// // //               <select className="w-full text-xs text-slate-700 bg-transparent pr-6 font-medium appearance-none outline-none cursor-pointer">
// // //                 <option value="">Select Class</option>
// // //                 <option value="class-6-8">Class 6 - 8</option>
...
// // //           {/* Subject Field */}
// // //           <div className="flex flex-col">
// // //             <span className="text-[11px] font-bold text-slate-700 mb-1">Subject</span>
// // //             <div className="relative border border-slate-300 rounded-lg px-3 py-2 bg-white focus-within:border-blue-500 transition shadow-sm h-11 flex items-center">
// // //               <select className="w-full text-xs text-slate-700 bg-transparent pr-6 font-medium appearance-none outline-none cursor-pointer">
// // //                 <option value="">Select Subject</option>
// // //                 <option value="maths">Mathematics</option>
...
// // //           {/* Sort By Field */}
// // //           <div className="flex flex-col">
// // //             <span className="text-[11px] font-bold text-slate-700 mb-1">Sort by</span>
// // //             <div className="relative border border-slate-300 rounded-lg px-3 py-2 bg-white focus-within:border-blue-500 transition shadow-sm h-11 flex items-center">
// // //               <select className="w-full text-xs text-slate-700 bg-transparent pr-6 font-medium appearance-none outline-none cursor-pointer">
// // //                 <option value="">Select Option</option>
// // //                 <option value="price-asc">Price: Low to High</option>
...
// //     reviewsCount: 128,
// //     price: "₹4,500 / month",
// //     about: "Dedicated physics educator focused on conceptual clarity, problem-solving techniques, and competitive exam preparation (JEE Main & Advanced).",
...
// //     reviewsCount: 52,
// //     price: "₹5,000 / month",
// //     about: "Specialized in building strong foundations in pure mathematics, algebra, and geometry with interactive step-by-step guidance.",
...
// //     reviewsCount: 80,
// //     price: "₹6,000 / month",
// //     about: "Helping students overcome math anxiety through practical problem solving and consistent evaluation.",
...
// //     reviewsCount: 96,
// //     price: "₹6,500 / month",
// //     about: "Passionate educator with an engineering background offering structured curriculum coverage and exam mastery.",
...
// //     reviewsCount: 64,
// //     price: "₹7,000 / month",
// //     about: "Expert in competitive mechanics, electromagnetism, and modern physics with personalized attention.",
...
// //     reviewsCount: 58,
// //     price: "₹7,500 / month",
// //     about: "Focused on concept retention and rigorous weekly assessment tests.",
...
// // function ProfileLocalTutor({ tutor, onBack }: { tutor: Tutor; onBack: () => void }) {
// //   return (
// //     <div className="max-w-5xl mx-auto px-4 pt-6">
// //       {/* Back Button */}
// //       <button 
// //         onClick={onBack} 
// //         className="flex items-center gap-2 text-xs font-semibold text-slate-600 hover:text-blue-600 transition mb-6 cursor-pointer bg-white px-3 py-2 rounded-lg border border-slate-200 w-fit"
// //       >
...
// //         {/* Left Column: Tutor Card Overview */}
// //         <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm flex flex-col items-center text-center h-fit">
// //           <img 
// //             src={tutor.image} 
// //             alt={tutor.name} 
// //             className="w-28 h-28 rounded-full object-cover object-top border-4 border-orange-100 shadow-md mb-4"
// //           />
// //           <div className="flex items-center gap-1.5">
// //             <h2 className="text-xl font-bold text-slate-900">{tutor.name}</h2>
// //             <CheckCircle className="w-5 h-5 text-blue-500 fill-blue-500 text-white shrink-0" />
// //           </div>
// //           <p className="text-xs text-slate-500 font-medium mt-1">{tutor.degree}</p>

// //           <div className="flex items-center gap-1 my-3 bg-amber-50 px-3 py-1 rounded-full border border-amber-200">
// //             <Star className="w-4 h-4 fill-amber-400 text-amber-400" />
// //             <span className="text-xs font-bold text-slate-800">{tutor.rating}</span>
// //             <span className="text-[11px] text-slate-500">({tutor.reviewsCount} Reviews)</span>
// //           </div>

// //           <div className="w-full bg-[#EDF7EE] text-[#2E7D32] py-2 text-sm font-bold rounded-xl mb-4">
// //             {tutor.price}
// //           </div>

// //           <div className="w-full space-y-2">
// //             <button className="w-full py-2.5 text-xs font-semibold text-white bg-[#FF4500] hover:bg-[#E03E00] rounded-xl transition flex items-center justify-center gap-2 shadow-sm">
// //               <Phone className="w-4 h-4" /> Book Demo / Contact
// //             </button>
// //             <button className="w-full py-2.5 text-xs font-semibold text-blue-600 border border-blue-500 rounded-xl hover:bg-blue-50 transition flex items-center justify-center gap-2">
...
// //             <h3 className="text-base font-bold text-slate-900 mb-3">About Tutor</h3>
// //             <p className="text-xs leading-relaxed text-slate-600">
// //               {tutor.about || "Experienced educator dedicated to academic excellence and comprehensive student mentoring."}
// //             </p>
// //           </div>

// //           {/* Academic & Teaching Info */}
// //           <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
// //             <h3 className="text-base font-bold text-slate-900 mb-4">Teaching Details</h3>
...
// //                   <span className="text-xs font-bold text-slate-800">{tutor.experience}</span>
// //                 </div>
// //               </div>
...
// //                 <div>
// //                   <span className="text-[11px] text-slate-400 block font-medium">Classes Covered</span>
// //                   <span className="text-xs font-bold text-slate-800">{tutor.classes}</span>
// //                 </div>
// //               </div>
...
// //                 <div>
// //                   <span className="text-[11px] text-slate-400 block font-medium">Subjects</span>
// //                   <span className="text-xs font-bold text-slate-800">{tutor.subjects}</span>
// //                 </div>
// //               </div>
...
// //                 <div>
// //                   <span className="text-[11px] text-slate-400 block font-medium">Location & Mode</span>
// //                   <span className="text-xs font-bold text-slate-800">{tutor.location || "Local Area"} ({tutor.mode || "Home Tuition"})</span>
// //                 </div>
// //               </div>
// //             </div>
// //           </div>
...
// //           {/* Trust Badges */}
// //           <div className="bg-[#FFF6F0] rounded-2xl p-4 border border-orange-100 flex items-center justify-between gap-4">
// //             <div className="flex items-center gap-3">
// //               <ShieldCheck className="w-8 h-8 text-[#2E7D32]" />
// //               <div>
// //                 <h4 className="text-xs font-bold text-slate-900">Background & ID Verified</h4>
// //                 <p className="text-[10px] text-slate-500">Documents and qualification credentials authenticated.</p>
// //               </div>
// //             </div>
// //           </div>
// //         </div>
...
// //                   <div>
// //                     <h4 className="text-[11px] font-bold text-slate-800 leading-tight">Personalized<br/>Home Tuition</h4>
// //                     <p className="text-[9px] text-slate-500 mt-0.5 leading-tight">One-to-one attention for better understanding.</p>
// //                   </div>
// //                 </div>
...
// //                   <div>
// //                     <h4 className="text-[11px] font-bold text-slate-800 leading-tight">Experienced<br/>Mentors</h4>
// //                     <p className="text-[9px] text-slate-500 mt-0.5 leading-tight">Learn from qualified & verified mentors.</p>
// //                   </div>
// //                 </div>
...
// //                   <div>
// //                     <h4 className="text-[11px] font-bold text-slate-800 leading-tight">Better Results</h4>
// //                     <p className="text-[9px] text-slate-500 mt-0.5 leading-tight">Regular assessments & concept clarity.</p>
// //                   </div>
// //                 </div>
...
// //                   <div>
// //                     <h4 className="text-[11px] font-bold text-slate-800 leading-tight">Safe & Trusted</h4>
// //                     <p className="text-[9px] text-slate-500 mt-0.5 leading-tight">Background verified tutors.</p>
// //                   </div>
// //                 </div>
...
// //                   <div>
// //                     <h4 className="text-[11px] font-bold text-slate-800 leading-tight">Flexible &<br/>Convenient</h4>
// //                     <p className="text-[9px] text-slate-500 mt-0.5 leading-tight">Choose timing & days easily.</p>
// //                   </div>
// //                 </div>
// //               </div>
...
// //                       className="w-full py-1.5 text-xs font-semibold text-blue-600 border border-blue-500 rounded-lg hover:bg-blue-50 transition cursor-pointer"
// //                     >
// //                       View Profile
// //                     </button>
// //                     <button className="w-full py-1.5 text-xs font-semibold text-white bg-[#FF4500] hover:bg-[#E03E00] rounded-lg transition shadow-sm">
...
export default function TutorsListingPage() {
  ...
  const handleNavigateToProfile = (tutorId: number) => {
    // Router dependency break na ho isliye direct route navigation
    window.location.href = `/profilelocaltutor/${tutorId}`;
  };
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-700 font-sans pb-12">
      ...
      <Header/>
      {/* <header className="bg-white border-b border-slate-200 py-3 px-4 mb-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <span className="font-bold text-slate-900 text-lg tracking-tight">FindMyTutor</span>
        </div>
      </header> */}
          ...
          {tutorsData.map((tutor) => (
            ...
            >
              ...
              <div className="mt-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button 
                    onClick={() => handleNavigateToProfile(tutor.id)}
                    className="w-full py-1.5 text-xs font-semibold text-blue-600 border border-blue-500 rounded-lg hover:bg-blue-50 active:bg-blue-100 transition cursor-pointer"
                  >
                    View Profile
                  </button>
                  <button className="w-full py-1.5 text-xs font-semibold text-white bg-[#FF4500] hover:bg-[#E03E00] active:bg-[#c93700] rounded-lg transition shadow-sm cursor-pointer">
                    Contact
                  </button>
                </div>
              </div>
