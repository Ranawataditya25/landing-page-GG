...
// //     exp: "10+ Years",
// //     imgUrl: "https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=300&q=80",
// //   },
// //   {
// //     id: 7,
// //     name: "Saurabh Mehta",
...
// //                   </div>
// //                   <p className="text-xs text-slate-500 mt-0.5">{mentor.college}</p>
...
// //                   <button className="py-2.5 px-3 border border-orange-500 text-orange-500 hover:bg-orange-50 text-xs font-bold rounded-xl transition-all">
// //                     View Profile
// //                   </button>
// //                   <button className="py-2.5 px-3 bg-orange-500 hover:bg-orange-600 text-white text-xs font-bold rounded-xl transition-all shadow-md shadow-orange-200">
// //                     Book Session
// //                   </button>
// //                 </div>
// //               </div>
...
// //             }`}
// //           > Eloper All MEntor</span>
// //         ))}
// //       </div>   */}

// // <button className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-8 flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg font-medium text-xm transition-colors shadow-md">
...
//       {/* Navigation Button to mentordetail */}
//       <button
//         onClick={() => navigate("/mentordetail")}
