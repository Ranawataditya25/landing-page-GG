...
// //           {/* <h1 className="text-3xl sm:text-4xl font-bold text-orange tracking-tight">
// //             All Mentors
// //           </h1> */}
...
// //         {/* <button 
// //           aria-label="Previous"
// //           className="absolute -left-3 top-1/2 -translate-y-1/2 z-20 w-8 h-8 bg-gray-600/80 hover:bg-gray-700 text-white rounded-full flex items-center justify-center shadow-md transition-all"
// //         >
...
// //         {/* <button 
// //           aria-label="Next"
// //           className="absolute -right-3 top-1/2 -translate-y-1/2 z-20 w-8 h-8 bg-gray-600/80 hover:bg-gray-700 text-white rounded-full flex items-center justify-center shadow-md transition-all"
// //         >
...
// //               Why Learn with <br className="hidden lg:block"/>GoodGuiders Mentorship?
// //             </h2> */}
// //             <h2 className="text-lg font-bold text-[#0b132a] leading-tight">
...
// //               <div 
// //                 key={step.id} 
// //                 className="flex flex-col space-y-2 p-2 rounded-xl hover:bg-orange-50/30 transition-colors"
// //               >
...
//           {/* Navigation Button using Link (Error Free) */}
//           <div className="pt-3">
//             <Link
//               to="/mentordetail"
