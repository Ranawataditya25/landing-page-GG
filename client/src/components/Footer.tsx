...
// // import { insertNewsletterSchema, type InsertNewsletter } from "@/lib/schema";
...
// //         "https://goodguiders-maxbrain.onrender.com/api/storage/newsletter",
// //         {
// //           method: "POST",
// //           headers: {
...
// import { useMutation } from "@tanstack/react-query";
// import { useToast } from "@/hooks/use-toast";
// import { Twitter, Linkedin, Instagram, MessageSquare, Loader2 } from "lucide-react";
...
//           {/* 1. Company Info & WhatsApp Contact */}
//           <div className="space-y-4">
//             <h3 className="text-2xl font-bold tracking-tight text-white">
//               Good Guiders <span className="text-orange-400">for India</span>
//             </h3>
//             <p className="text-gray-400 text-sm leading-relaxed">
//               Empowering students with quality mentorship, career counseling, and skill development across India.
//             </p>
//             <div className="pt-2">
//               <a
//                 href={whatsappUrl}
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-medium rounded-md transition-colors shadow-sm"
//               >
...
//           <div>
//             <h4 className="text-lg font-semibold mb-5 text-white">Stay Updated</h4>
//             <p className="text-gray-400 text-sm mb-4">
//               Subscribe to our newsletter for the latest guidance and updates.
//             </p>
...
//           <p className="text-gray-400 text-sm">
//             Copyright © {new Date().getFullYear()} Good Guiders for India. All rights reserved.
//           </p>
//           <p className="text-gray-400 text-sm">
//             Designed &amp; Developed by{" "}
//             <a
...
//               target="_blank"
//               rel="noopener noreferrer"
//               className="text-orange-400 font-semibold hover:text-orange-300 transition-colors underline underline-offset-4"
//             >
//               Maxbrain Technologies
//             </a>
//           </p>
